...
<div class="box_con04">
    <form method="POST" action="{{ route('update',['id' => $sake['id'] ]) }}" onsubmit="return checkSubmit()">
    @csrf
    ...
    <li>
        ...
        <div class="box_det"><input size="20" type="text" class="wide" name="sakename" value="{{ $sake['sakename'] }}"/>
    ...
    <li>
        ...
        <div class="box_det"><select name="prefecturename">
            <option value="{{ $sake['prefecturename'] }}">{{ $sake['prefecturename'] }}</option>
      ...
      <li>
        ...
        <div class="box_det"><select name="scent">
            <option value="{{ $sake['scent'] }}">{{ $sake['scent'] }}</option>
      ...
      <li>
         ...
         <div class="box_det"><select name="acidity">
            <option value="{{ $sake['acidity'] }}">{{ $sake['acidity'] }}</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
            <option value="4">4</option>
      ...
      <li>
        ...
        <div class="box_det"><select name="taste">
            <option value="{{ $sake['taste'] }}">{{ $sake['taste'] }}</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
            <option value="4">4</option>
      ...
      <li>
        ...
        <div class="box_det"><select name="sweetness">
            <option value="{{ $sake['sweetness'] }}">{{ $sake['sweetness'] }}</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
            <option value="4">4</option>
      ...
      <li>
        ...
        <div class="box_det"><select name="score">
            <option value="{{ $sake['score'] }}">{{ $sake['score'] }}</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
            <option value="4">4</option>
    ...
    <p class="btn">
        <span><input type="submit" value=" 更新する " /></span>
    </p>
